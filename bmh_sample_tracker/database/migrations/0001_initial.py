# Generated by Django 4.1.9 on 2023-05-11 13:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('sample_id', models.CharField(default=database.models.generate_sample_id, max_length=50)),
                ...
                ('submitter_project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='database.project')),
                ('submitting_lab', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='database.lab')),
            ],
            options={
                'verbose_name': 'Sample',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submitting_lab', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='database.lab')),
            ],
            options={
